...
```json
{
  "mcpServers": {
    "reverse-shell": {
      ...
      "args": ["/absolute/path/to/CyberStrikeAI-EV-main/mcp-servers/reverse_shell/mcp_reverse_shell.py"]
    }
  }
}
```
