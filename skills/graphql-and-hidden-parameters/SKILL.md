...
- If hidden fields affect privilege: [api authorization and bola](../idor-broken-object-authorization/SKILL.md)
- If GraphQL batching changes auth or rate behavior: [api auth and jwt abuse](../jwt-oauth-token-attacks/SKILL.md)
- If endpoint discovery is incomplete: [api recon and docs](../api-sec/SKILL.md)